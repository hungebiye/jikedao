...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`vue` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `account` (
  ...
  `userPhone` char(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `avatar` char(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `userAddress` char(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `commoditylist` (
  `id` char(20) NOT NULL,
  `img` char(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
