<template>
  <div id="Login">
    <div class="login">
      ...
      <div>
        <span id="span" class="user">密 码:</span>
        <el-input type="password" v-model="pass" :style="{ width: '300px', 'padding-left': '2px' }" />
      </div>
      <el-button style="margin-bottom: 20px; width: 150px;" type="primary" v-on:click="check">登录</el-button>
      <div style="display: flex; justify-content: space-between; width: 80%">
        <el-link type="primary" @click="$router.push('/')">返回首页</el-link>
        <el-link type="primary" @click="$router.push('/register')">前往注册</el-link>
      </div>
    </div>
  </div>
</template>
